...
var $author$project$Main$init = {counter: 0, textcont: ''};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Hello i am a paragraph')
					])),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$placeholder('textfield'),
						$elm$html$Html$Attributes$value(model.textcont),
